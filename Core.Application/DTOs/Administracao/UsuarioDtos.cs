...
public sealed record SalvarUsuarioRequest(string Nome, string Email, string Perfil, DateOnly? DataNascimento = null, bool? Status = null, IReadOnlyCollection<SalvarModuloUsuarioRequest>? ModulosAtivos = null);
public sealed record AlterarSenhaRequest(string SenhaAtual, string NovaSenha, string ConfirmarSenha);
public sealed record UsuarioDto(int Id, string Nome, string Email, string Perfil, DateOnly? DataNascimento, DateTime DataCriacao);
...
public sealed record UsuarioDetalheDto(int Id, string Nome, string Email, string Perfil, DateOnly? DataNascimento, bool Status, DateTime DataCriacao, IReadOnlyCollection<ModuloUsuarioDto> ModulosAtivos);
