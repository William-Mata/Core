...
public sealed record CriarDespesaRequest(string Descricao, string? Observacao, DateOnly DataLancamento, DateOnly DataVencimento, string TipoDespesa, string TipoPagamento, Recorrencia Recorrencia, decimal ValorTotal, decimal Desconto, decimal Acrescimo, decimal Imposto, decimal Juros, IReadOnlyCollection<string> AmigosRateio, IReadOnlyCollection<string> TiposRateio, string? AnexoDocumento, IReadOnlyDictionary<string, decimal>? RateioAmigosValores = null, IReadOnlyCollection<DespesaAreaRateioRequest>? AreasRateio = null, int? QuantidadeRecorrencia = null, IReadOnlyCollection<AmigoRateioRequest>? Amigos = null);
