...
public sealed record ListarDespesasRequest(string? Id, string? Descricao, string? Competencia, DateOnly? DataInicio, DateOnly? DataFim);
...
public sealed record DespesaListaDto(long Id, string Descricao, DateOnly DataLancamento, DateOnly DataVencimento, DateOnly? DataEfetivacao, string TipoDespesa, string TipoPagamento, decimal ValorTotal, decimal ValorLiquido, decimal? ValorEfetivacao, string Status, MeioFinanceiroVinculoDto? Vinculo);
