...
public interface IHistoricoTransacaoFinanceiraRepository
{
    ...
    Task MarcarOcultoPorTransacaoAsync(TipoTransacaoFinanceira tipoTransacao, long transacaoId, CancellationToken cancellationToken = default) => Task.CompletedTask;
